...
pub const approved_words = [_][]const u8{
    ...
    "than",    "that",    "this",    "these",   "those",   "with",    "without", "from",
    "to",      "into",    "on",      "off",     "in",      "out",     "at",      "by",
    "for",     "of",      "not",     "no",      "all",     "each",    "every",   "more",
    "less",    "first",   "last",    "next",    "again",   "also",    "only",    "before",
    "after",   "when",    "while",   "you",     "your",    "it",      "its",     "is",
    "are",     "be",      "can",     "will",    "must",    "do",      "does",    "did",
    // Approved nouns used across the product
    "agent",   "block",   "button",  "command", "computer", "data",   "directory", "error",
    "file",    "folder",  "key",     "line",    "list",    "log",     "message", "name",
    "network", "number",  "option",  "output",  "page",    "path",    "process", "program",
    "prompt",  "record",  "result",  "screen",  "server",  "session", "shell",   "system",
    "task",    "terminal", "test",   "text",    "time",    "tool",    "user",    "value",
    "window",  "workspace", "step",  "menu",    "panel",   "report",  "rule",    "policy",
