...
pub const entries = [_]C{
    ...
    .{
        .id = "ai-system",
        .preferred = "AI system",
        .definition = "engineered system that produces outputs such as predictions, recommendations or decisions from data, for objectives a person set",
        .relations = &.{.{ .kind = .associative, .target = "agent" }},
        .top_concept = true,
    ...
    .{
        ...
        .definition = "way of building a system in which behaviour is derived from data rather than written as rules",
        .relations = &.{.{ .kind = .associative, .target = "ai-system" }},
        .top_concept = true,
        .source = "ISO/IEC 22989",
    },
    .{
        .id = "model",
        .preferred = "model",
        .definition = "part of an AI system that produces an output for a given input, using what was derived during training",
        .relations = &.{.{ .kind = .partitive, .target = "ai-system" }},
        .source = "ISO/IEC 22989",
    },
    .{
        .id = "inference",
        .preferred = "inference",
        .definition = "act of producing an output from a trained model for one input",
        .relations = &.{.{ .kind = .associative, .target = "model" }},
        .top_concept = true,
        .source = "ISO/IEC 22989",
    },
    .{
        ...
        .definition = "dataset used to derive a model's behaviour",
        .relations = &.{.{ .kind = .generic, .target = "dataset" }},
        .source = "ISO/IEC 22989",
    },
    .{
        .id = "ai-lifecycle-process",
        .preferred = "AI lifecycle process",
        .definition = "named process that an AI system passes through, from stating what it is for to withdrawing it from use",
        .relations = &.{.{ .kind = .associative, .target = "ai-system" }},
        .top_concept = true,
        .source = "ISO/IEC 5338",
    },
    .{
        .id = "human-oversight",
        .preferred = "human oversight",
        .definition = "arrangement by which a person can understand, direct, override and stop what an AI system does",
        .relations = &.{
            .{ .kind = .associative, .target = "ai-system" },
            .{ .kind = .associative, .target = "approval" },
        },
        .top_concept = true,
    ...
    .{
        ...
        .preferred = "documented information",
        .definition = "information a party must control, together with the medium it is held on and the rules for keeping it current",
        .relations = &.{.{ .kind = .generic, .target = "artifact" }},
        .source = "ISO 10013",
    },
    .{
